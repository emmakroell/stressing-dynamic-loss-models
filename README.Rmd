...
We decide to stress the 90\% VaR of the model down 20\%. this code imposes the stress and simulates under the model.
...
Now we want to impose an additional constraint, corresponding to a 10\% decrease in CVaR (also known as Expected Shortfall).
